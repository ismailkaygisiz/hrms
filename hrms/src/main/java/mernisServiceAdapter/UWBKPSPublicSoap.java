...
public class UWBKPSPublicSoap
{
    ...
    public UWBKPSPublicSoap(){}

    public UWBKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public UWBKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        UWBExtendedSoapSerializationEnvelope envelope= new UWBExtendedSoapSerializationEnvelope(UWBExtendedSoapSerializationEnvelope.VER11);
