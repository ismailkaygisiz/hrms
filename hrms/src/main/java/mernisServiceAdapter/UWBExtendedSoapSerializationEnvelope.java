...
public class UWBExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(UWBDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new UWBStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static UWBDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static UWBDateTimeConverter dateTimeConverter = new UWBStandardDateTimeConverter();

    public UWBExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public UWBExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new UWBMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=UWBHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,UWBExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=UWBHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
